...
App.prototype._init = function() {
  ...
  //this.scriptUrl = null;
  this.scriptUrl = this._getResourceUrl('bundle');
...
App.prototype._getResourceUrl = function(type) {
...
App.prototype._loadProductionStyles = function() {
  var styleUrl = this._getResourceUrl('style');
  var source =
    '<link rel="stylesheet" type="text/css" href="' + styleUrl + '">';
  this.views.register(styleUrl, source, {serverOnly: true});

  var stylesView = this.views.find('Styles');
  stylesView.source += '<view name="' + styleUrl + '"></view>';
};
